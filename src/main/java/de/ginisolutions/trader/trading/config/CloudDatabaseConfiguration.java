...
@Configuration
@EnableMongoRepositories("de.ginisolutions.trader.trading.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("de.ginisolutions.trader.trading.config.dbmigrations");
